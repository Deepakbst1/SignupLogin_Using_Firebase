        ...
        {flag ? (
          <div className="signup-signin-container">
            <h2 style={{ textAlign: "center" }}>
              <i className="bi bi-person-fill"></i> Log In on <span className="blue-text">Relu Consultancy</span>
            </h2>
          ...
          <div className="signup-signin-container">
            <h2 style={{ textAlign: "center" }}>
              <i className="bi bi-person-plus-fill"></i> Sign Up on <span className="blue-text">Relu Consultancy</span>
            </h2>
            <form onSubmit={signUpWithEmail}>
              <div className="input-wrapper">
                <p>Full Name</p>
